...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '8755e778f1774c528ae9a68eb0066139',
  PSEUDO_STATIC: process.env.NEXT_PUBLIC_PSEUDO_STATIC || false, // 伪静态路径，开启后所有文章URL都以 .html 结尾。
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 5, // 更新内容缓存间隔 单位(秒)；即每个页面有5秒的纯静态期、此期间无论多少次访问都不会抓取notion数据；调大该值有助于节省Vercel资源、同时提升访问速率，但也会使文章更新有延迟。
  THEME: process.env.NEXT_PUBLIC_THEME || 'mengyao', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Mengyao', // 昵称
  BIO: process.env.NEXT_PUBLIC_BIO || 'It s just me', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://mengyaoblog.vercel.app/', // 网站地址
  ...
  LAYOUT_MAPPINGS: {
    ...
    '/post': 'LayoutPostList',
    '/post/[post]': 'LayoutPostList',
    '/photography': 'LayoutPhotographyList',
    '/about': 'LayoutAbout',
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Mengyao', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
